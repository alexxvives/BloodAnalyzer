...
- Still cannot grade without inventing: female cycle-phase estradiol/FSH/LH (no cycle day), female PSA (Mayo N/A), remaining calculated ratios (TG:HDL, LDL:ApoB, FAI, T:C, cortisol:DHEA-S, % free T, free T3:T4, TSH:T4), UIBC, VLDL. Electrolytes still not in the catalog.
