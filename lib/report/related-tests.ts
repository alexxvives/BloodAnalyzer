...
const RELATED_BY_TRIGGER: Record<string, string[]> = {
  ...
  transferrin: ["ferritin", "serum-iron", "tibc"],
  tibc: ["ferritin", "serum-iron", "transferrin"],
  "ldl-cholesterol": ["apo-b", "lp-a", "triglycerides", "hdl-cholesterol"],
  "total-cholesterol": [
    "ldl-cholesterol",
    "hdl-cholesterol",
    "triglycerides",
  ...
  "glucose-fasting": ["hba1c", "insulin"],
  hba1c: ["glucose-fasting", "insulin"],
  insulin: ["glucose-fasting", "hba1c"],
  tsh: ["free-t4", "free-t3"],
  "free-t4": ["tsh", "free-t3"],
  "free-t3": ["tsh", "free-t4"],
  ...
  ggt: ["alt", "ast"],
  "bilirubin-total": ["alt", "ast", "albumin"],
  cortisol: ["dhea-s", "tsh"],
